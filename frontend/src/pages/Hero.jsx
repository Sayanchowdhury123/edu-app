    ...
    return(
     <section className="min-h-[93vh] flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white px-6">
       <div className="text-center max-w-2xl">
           <motion.h1 className="text-5xl md:text-6xl font-semibold mb-6 drop-shadow-lg" initial={{y:-50,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:0.8 , type:"spring"}}>
